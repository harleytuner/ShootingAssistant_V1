...
void ui_Options_Page_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_Options_Page, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_OptionsPageLabel = lv_label_create(ui_Options_Page);
    lv_obj_set_width(ui_OptionsPageLabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_OptionsPageLabel, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_add_flag(ui_Page_1, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_Page_1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_BubbleLevelBTN = lv_label_create(ui_Page_1);
    lv_obj_set_width(ui_BubbleLevelBTN, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_BubbleLevelBTN, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_add_flag(ui_Page2, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_Page2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_HorizonBTN = lv_label_create(ui_Page2);
    lv_obj_set_width(ui_HorizonBTN, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_HorizonBTN, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_add_flag(ui_Page3, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_Page3, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_ShotCounterBTN = lv_label_create(ui_Page3);
    lv_obj_set_width(ui_ShotCounterBTN, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_ShotCounterBTN, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_add_flag(ui_Page4, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_Page4, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_StageTimerBTN1 = lv_label_create(ui_Page4);
    lv_obj_set_width(ui_StageTimerBTN1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_StageTimerBTN1, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_add_flag(ui_Page5, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_Page5, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_CompetitionBTN1 = lv_label_create(ui_Page5);
    lv_obj_set_width(ui_CompetitionBTN1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_CompetitionBTN1, LV_SIZE_CONTENT);    /// 1
